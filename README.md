...
ArchDAO API: Backend API for the ArchDAO futarchy-based governance platform.
<!-- End Summary [summary] -->
...
* [createNonce](docs/sdks/auth/README.md#createnonce) - Create nonce
* [login](docs/sdks/auth/README.md#login) - Login
* [logout](docs/sdks/auth/README.md#logout) - Logout
* [listNonces](docs/sdks/auth/README.md#listnonces) - List active sessions
...
* [getProposal](docs/sdks/proposal/README.md#getproposal) - Get proposal
* [updateProposal](docs/sdks/proposal/README.md#updateproposal) - Update proposal
* [deleteProposal](docs/sdks/proposal/README.md#deleteproposal) - Delete proposal
* [listStakes](docs/sdks/proposal/README.md#liststakes) - List stakes
* [listTrades](docs/sdks/proposal/README.md#listtrades) - List trades

### [raise](docs/sdks/raise/README.md)

* [listRaises](docs/sdks/raise/README.md#listraises) - List raises
* [getRaise](docs/sdks/raise/README.md#getraise) - Get raise
* [updateRaise](docs/sdks/raise/README.md#updateraise) - Update raise
* [listContributions](docs/sdks/raise/README.md#listcontributions) - List contributions
...
- [`authCreateNonce`](docs/sdks/auth/README.md#createnonce) - Create nonce
- [`authListNonces`](docs/sdks/auth/README.md#listnonces) - List active sessions
- [`authLogin`](docs/sdks/auth/README.md#login) - Login
...
- [`proposalDeleteProposal`](docs/sdks/proposal/README.md#deleteproposal) - Delete proposal
- [`proposalGetProposal`](docs/sdks/proposal/README.md#getproposal) - Get proposal
- [`proposalListProposals`](docs/sdks/proposal/README.md#listproposals) - List proposals
- [`proposalListStakes`](docs/sdks/proposal/README.md#liststakes) - List stakes
- [`proposalListTrades`](docs/sdks/proposal/README.md#listtrades) - List trades
- [`proposalUpdateProposal`](docs/sdks/proposal/README.md#updateproposal) - Update proposal
- [`raiseGetRaise`](docs/sdks/raise/README.md#getraise) - Get raise
- [`raiseListContributions`](docs/sdks/raise/README.md#listcontributions) - List contributions
- [`raiseListRaises`](docs/sdks/raise/README.md#listraises) - List raises
- [`raiseUpdateRaise`](docs/sdks/raise/README.md#updateraise) - Update raise
- [`userGetUser`](docs/sdks/user/README.md#getuser) - Get user
- [`userListUsers`](docs/sdks/user/README.md#listusers) - List users
...
* [`ArchDaoError`](./src/models/errors/archdaoerror.ts): The base class for HTTP error responses.
  * [`ErrorResponse`](docs/models/errors/errorresponse.md): Validation error. *
