...
import { organizationConfigureRaise } from "../funcs/organizationConfigureRaise.js";
...
export class Organization extends ClientSDK {
   ...
   */
  async configureRaise(
    request: operations.ConfigureRaiseRequest,
    options?: RequestOptions,
  ): Promise<operations.ConfigureRaiseResponseBody> {
    return unwrapAsync(organizationConfigureRaise(
      this,
      request,
      options,
    ));
