...
import { ActivateRaiseResponseBody } from "../models/operations/activateraise.js";
import {
...
export class Organization extends ClientSDK {
  ...
  async createOrganization(
    ...
    options?: RequestOptions,
  ): Promise<CreateOrganizationResponseBody> {
  ...
  async editOrganization(
    ...
    options?: RequestOptions,
  ): Promise<EditOrganizationResponseBody> {
  ...
  async changeOrganizationStatus(
    ...
    options?: RequestOptions,
  ): Promise<ChangeOrganizationStatusResponseBody> {
  ...
  async activateRaise(
    id: number,
    options?: RequestOptions,
  ): Promise<ActivateRaiseResponseBody> {
