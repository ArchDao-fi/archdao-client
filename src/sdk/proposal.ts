...
import { CreateProposalResponseBody } from "../models/operations/createproposal.js";
import {
  GetProposalResponseBody,
  GetProposalSecurity,
} from "../models/operations/getproposal.js";
import { InitializeProposalResponseBody } from "../models/operations/initializeproposal.js";
import {
  ListProposalsRequest,
  ListProposalsResponseBody,
  ListProposalsSecurity,
} from "../models/operations/listproposals.js";
import { ListProposalStakesResponseBody } from "../models/operations/listproposalstakes.js";
import {
...
export class Proposal extends ClientSDK {
  ...
  async createProposal(
    ...
    options?: RequestOptions,
  ): Promise<CreateProposalResponseBody> {
  ...
  async getProposal(
    ...
    options?: RequestOptions,
  ): Promise<GetProposalResponseBody> {
  ...
  async initializeProposal(
    id: number,
    options?: RequestOptions,
  ): Promise<InitializeProposalResponseBody> {
  ...
  async listProposalStakes(
    ...
    options?: RequestOptions,
  ): Promise<ListProposalStakesResponseBody> {
  ...
  async listProposalTrades(
    ...
    side?: Side | undefined,
    options?: RequestOptions,
  ): Promise<ListProposalTradesResponseBody> {
