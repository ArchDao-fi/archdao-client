 ...
 */
export function proposalListTrades(
  client: ArchDAOCore,
  ...
  Result<
    operations.ListTradesResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListTradesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListTradesResponseBody$inboundSchema),
