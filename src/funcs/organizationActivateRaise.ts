...
import {
  ...
  ActivateRaiseResponse$inboundSchema,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ActivateRaiseResponse$inboundSchema),
    M.json([400, 401, 403, 404], ActivateRaiseResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
