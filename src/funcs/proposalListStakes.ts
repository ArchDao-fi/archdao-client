 ...
 */
export function proposalListStakes(
  client: ArchDAOCore,
  ...
  Result<
    operations.ListStakesResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListStakesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListStakesResponseBody$inboundSchema),
