 ...
 */
export function authListNonces(
  client: ArchDAOCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListNoncesResponseBody,
...
> {
  const path = pathToFunc("/auth/nonces")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListNoncesResponseBody$inboundSchema),
