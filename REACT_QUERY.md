...
import { ArchDAOCore } from "@archdao/archdao-client";
import { ArchDAOProvider } from "@archdao/archdao-client/react-query";
...
queryClient.setQueryDefaults(["@archdao/archdao-client"], { retry: false });
queryClient.setMutationDefaults(["@archdao/archdao-client"], { retry: false });

export function App() {
  return (
    <QueryClientProvider client={queryClient}>
      <ArchDAOProvider client={archDAO}> 
...
```tsx
import { useAuthenticationGetSelf } from "@archdao/archdao-client/react-query/authenticationGetSelf.js";

export function Example() {
  const { data, error, status } = useAuthenticationGetSelf();
...
```tsx
import { useAuthenticationCreateNonceMutation } from "@archdao/archdao-client/react-query/authenticationCreateNonce.js";

export function Example() {
  const { mutate, status } = useAuthenticationCreateNonceMutation();
...
import { invalidateAuthenticationGetSelf, invalidateAllAuthenticationGetSelf } from "@archdao/archdao-client/react-query/authenticationGetSelf.js";
// Replace this with a real mutation
import { useExampleMutation } from "@archdao/archdao-client/react-query/example.js";
      ...
      onSubmit={(e) => {
        ...
        mutate(formData, {
          onSuccess: () => {
            ...
            invalidateAuthenticationGetSelf(queryClient, /* ... arguments ... */);
            // OR, invalidate all cache entries for the query targets:
            invalidateAllAuthenticationGetSelf(queryClient);
          },
        });
      }}
    >
...
import { ArchDAOCore } from "@archdao/archdao-client";
import { ArchDAOProvider } from "@archdao/archdao-client/react-query";
import { useAuthenticationGetSelfSuspense } from "@archdao/archdao-client/react-query/authenticationGetSelf.js";
...
function Example() {
  const { data } = useAuthenticationGetSelfSuspense();
...
import { ArchDAOCore } from "@archdao/archdao-client";
import { prefetchAuthenticationGetSelf } from "@archdao/archdao-client/react-query/authenticationGetSelf.js";
...
export default async function Page() {
  ...
  await prefetchAuthenticationGetSelf(archDAO);
