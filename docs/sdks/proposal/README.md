...
**Promise\<[components.PaginatedProposals](../../models/components/paginatedproposals.md)\>**
...
**Promise\<[components.ProposalResponse](../../models/components/proposalresponse.md)\>**
...
**Promise\<[components.PaginatedStakes](../../models/components/paginatedstakes.md)\>**
...
**Promise\<[components.PaginatedTrades](../../models/components/paginatedtrades.md)\>**
