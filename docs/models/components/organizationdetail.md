...
```typescript
import { OrganizationDetail } from "@draft/archdao-api-typescript/models/components";
...
| `proposals`                                                                                   | [components.ProposalSummary](../../models/components/proposalsummary.md)[]                    | :heavy_minus_sign:                                                                            | N/A                                                                                           |
