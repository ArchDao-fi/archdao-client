...
let value: Organization = {
  type: "ico",
  name: "<value>",
  description: "stingy hmph upwardly provided",
  token: {
    name: "Example Token",
    symbol: "EXT",
    address: "0x1234...abcd",
...
| `type`                                                                                        | [components.Type](../../models/components/type.md)                                            | :heavy_check_mark:                                                                            | Type of organization                                                                          |
...
| `proposals`                                                                                   | [components.Proposal](../../models/components/proposal.md)[]                                  | :heavy_minus_sign:                                                                            | Organization proposals. Included when fetching by slug.                                       |
