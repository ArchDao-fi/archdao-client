...
```typescript
import { Trade } from "@draft/archdao-api-typescript/models/components";
...
| `decisionMarketId`                                                                            | *number*                                                                                      | :heavy_minus_sign:                                                                            | N/A                                                                                           |
| `address`                                                                                     | *string*                                                                                      | :heavy_minus_sign:                                                                            | N/A                                                                                           |
| `direction`                                                                                   | [components.TradeDirection](../../models/components/tradedirection.md)                        | :heavy_minus_sign:                                                                            | N/A                                                                                           |
