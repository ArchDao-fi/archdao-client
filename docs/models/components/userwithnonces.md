...
```typescript
import { UserWithNonces } from "@archdao/archdao-client/models/components/userwithnonces.js";
  ...
  nonces: [
    {
      ...
      ipAddress: "<client-ip>",
      created: new Date("2024-11-30T05:41:38.806Z"),
      updated: new Date("2024-07-02T14:57:33.515Z"),
    },
  ],
};
```
