...
```typescript
import { IcoOrganization } from "@archdao/archdao-client/models/operations/getorganization.js";

let value: IcoOrganization = {
  raise: {},
  token: {
    name: "Example Token",
    symbol: "EXT",
...
| `raise`                                                                                       | [components.Raise](../../models/components/raise.md)                                          | :heavy_check_mark:                                                                            | N/A                                                                                           |
