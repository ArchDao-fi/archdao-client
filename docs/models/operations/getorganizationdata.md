...
```typescript
import { GetOrganizationData } from "@archdao/archdao-client/models/operations/getorganization.js";

let value: GetOrganizationData = {
  token: {
    name: "Example Token",
    symbol: "EXT",
    address: "0x1234...abcd",
  ...
  proposals: [
    {
      organizationId: 819524,
      title: "<value>",
      description:
        "potentially traditionalism quantify yet apprehensive collectivization",
    },
  ],
};
```
