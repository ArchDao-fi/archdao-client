...
```typescript
import { DataExternalOrganization } from "@archdao/archdao-client/models/operations/getorganization.js";

let value: DataExternalOrganization = {
  token: {
    name: "Example Token",
    symbol: "EXT",
    address: "0x1234...abcd",
...
| `token`                                                                                       | [components.Token](../../models/components/token.md)                                          | :heavy_check_mark:                                                                            | N/A                                                                                           |
| `tokenSupply`                                                                                 | *number*                                                                                      | :heavy_check_mark:                                                                            | Token supply for treasury                                                                     |
| `usdcSupply`                                                                                  | *number*                                                                                      | :heavy_check_mark:                                                                            | USDC supply for treasury                                                                      |
