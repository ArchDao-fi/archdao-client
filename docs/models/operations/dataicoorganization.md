...
```typescript
import { DataIcoOrganization } from "@archdao/archdao-client/models/operations/getorganization.js";

let value: DataIcoOrganization = {
  raise: {},
  token: {
    name: "Example Token",
    symbol: "EXT",
...
| `raise`                                                                                       | [operations.DataRaise](../../models/operations/dataraise.md)                                  | :heavy_check_mark:                                                                            | N/A                                                                                           |
